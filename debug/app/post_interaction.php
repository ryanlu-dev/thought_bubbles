<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$sql = "INSERT INTO Interactions (ParentID, SessionID, StudentID, InteractionType, Content) VALUES (?, ?, ?, ?, ?)";

		if($stmt = mysqli_prepare($link, $sql)) {
			// Bind variables to the prepared statement as parameters
			$stmt->bind_param("iiiss", $ParentID, $SessionID, $StudentID, $InteractionType, $Content);
